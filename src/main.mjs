...
var GolPlayground = (function () {
    ...
    GolPlayground.prototype.preset = function (conf) {
        ...
        for (rowStart in conf.presets) {
            if (conf.presets.hasOwnProperty(rowStart)) {
                // checking if the row exist and the js default check!
            ...
            for (c = 0; c < this.colNo; c += 1) {
                cellEl = $(
                    '<div data-col="' +
                        ...
                        '" data-row="' +
                        r +
                        '" data-state="false" data-nextstate="false" id="cell-' +
                        r +
                        "-" +
                        c +
                        '" class="gol-cell col-' +
